    ...
    public partial class mig_01 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryMenus", x => x.CategoryMenuID);
                });
            ...
            migrationBuilder.CreateTable(
                name: "SpecialMealOffers",
                columns: table => new
                {
                    SpecialMealOfferID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecialMealOffers", x => x.SpecialMealOfferID);
                    table.ForeignKey(
                        name: "FK_SpecialMealOffers_CategoryMenus_CategoryMenuID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpecialMealOffers_CategoryMenuID",
                table: "SpecialMealOffers",
